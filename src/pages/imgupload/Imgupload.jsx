...
export default function Imgupload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setLoading(false); // 성공 여부와 관계없이 로딩 상태 종료
    }
  };
  ...
  return (
    <div className="relative w-full min-h-screen bg-white">
      {/* 상단 뒤로가기 아이콘 */}
      <div
        className="flex items-center ml-4 mt-4 mb-6 cursor-pointer w-6 h-6"
        onClick={handleNext}
      >
      ...
      >
        ...
        <div className="mt-3 flex flex-col gap-2">
          ...
          >
            <div className="bg-white text-gray-700 text-b4 rounded-md px-4 py-2">
              흔들리지 않았나요?
            </div>
          </div>
          <div
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center">
          <div className="bg-white bg-opacity-90 rounded-2xl p-6 w-80 text-center shadow-md">
            <img
              src={uploadImg}
              alt="uploading"
              className="mx-auto w-16 h-16 mb-4 animate-spin-slow"
            />
      ...
      {finalCheck && (
        <div
          className={`fixed inset-0 z-60 flex items-center justify-center bg-black bg-opacity-50
            ${
              fadeOut
                ? "animate-[fadeOut_0.5s_ease-forwards]"
        ...
        >
          <div className="flex flex-col items-center justify-center">
            <div
              ...
              ${
                fadeOut
                  ? "animate-[popOut_0.4s_ease_forwards]"
                  : "animate-[popIn_0.4s_ease_forwards]"
              }`}
            >
